...
```
###### Exemple 3 : extractions d'informations multiples dans la réponse de l'utilisateur

On peut aussi demander à l'IA d'extraire plusieurs informations dans la réponse de l'utilisateur, en les formatant au format JSON, ce qui facilite ensuite la récupération des différentes informations.

```markdown
## Question informations personnelles
Peux-tu me donner ton prénom, ton âge et ta ville de résidence ?
